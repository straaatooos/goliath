...
I will try to keep this up to date. I also will format this readme into proper markdown when I get off my vacation x)
...
Element Types:
Every Object has an Element Type. The integrated types were chosen based on IfcElement types, but several of the Ifc types were omitted to not overwhelm and slow down users, focusing on typically relevant types for smaller scale architecture. The selection is close to IfcBuildingElement types, though 
Future:
